"""
Django settings for vacuum_41925 project.
...
ROOT_URLCONF = 'vacuum_41925.urls'
...
WSGI_APPLICATION = 'vacuum_41925.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vacuum_41925 API",
    "DESCRIPTION": "API documentation for vacuum_41925 App",
    "VERSION": "v1",
}
